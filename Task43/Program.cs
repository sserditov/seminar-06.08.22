...
{
    Console.WriteLine(" ");
    Console.WriteLine($"Точка пересечения ({point1:f2} ; {point2:f2})");
}
else
{
    if (b1 == b2)
    {
        Console.WriteLine("Обе прямые совпадают, и не являются параллельными");
    }
    else
    {
        Console.WriteLine("Обе прямые параллельны");
    }
}
